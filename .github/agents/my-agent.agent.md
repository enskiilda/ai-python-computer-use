...
zastap cala poniższą integracje anthropic e2b przez ponizsza kernel oraz nvidia llama 4, NIE MODYFIKUJ STYLU DESIGNU UI FRONTENDU I ZAMIAST TWORZYC NOWY DOSTOSUJ GO DO BACKENDU python STAGEHAND MASZ OBOWIAZEK HARDCODOWAC API FRONTEND MA BYC bite w trybie unsafe - !!!!WAZNE AI WYKONUJE TASKA W INFINITE LOOP DOPOKI NIE WYSLLE KOMENDY GDY SKONCZY WYKONYWAAC TASKA CHCE BY AI I WYKONYWALA AKCJE I WYSYLALA WIADOMOSCI NA BIERZACO PISALA CO ROBI!!!! - NIE CHCE SSE TYLKO PRAWDZIWY REAL TIME LIVE STREAMING AI MA STEROWAĆ KERNEL SDK BRWISER POPRZED TAKIE COMPUTER TOOLS DO STEROWANIA BROWSER KERNEL # Computer Controls
...
<Info> Computer control actions are only available for browsers created after October 15, 2025. Older browser instances do not support these features. </Info>
Click the mouse
...
<CodeGroup> ```typescript Typescript/Javascript theme={null} import Kernel from '@onkernel/sdk';
...
<CodeGroup> ```typescript Typescript/Javascript theme={null} import fs from 'fs'; import { Buffer } from 'buffer'; import Kernel from '@onkernel/sdk';
const kernel = new Kernel();
const kernelBrowser = await kernel.browsers.create();
...
KERNEL_API_KEY="sk_0fc1b266-d4ea-40b1-9428-c5e91fe33715.zmMuKnvrhYkChScdXVBk7Z98xHh2p/1iSt6OrCwgL/Y"
 ...
 AI LLAMA 4 MUSI STEROWAĆ ONKERNEL BROWSER UZYWAJAC COMPUTER TOOLS JAKO FUNCTION CALLING PYTHON
